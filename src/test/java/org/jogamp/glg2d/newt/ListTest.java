...
public class ListTest extends NEWTUITest {
	private static final String[] DATA = new String[] { "AXE", "BUFFALO",
			"CARD", "DEER", "ENERGY", "FIELD", "GRAPHICS", "HOUSE", "IGLOO",
			"JAM", "KILT", "LOOSE", "MAN", "NEAT", "OPENGL", "PROFOUND",
			"QUOTE", "RASCAL", "STREET", "TOUGH", "UNDER", "VERTEX", "WILD",
			"X", "YOUNG", "Z-ORDER" };
