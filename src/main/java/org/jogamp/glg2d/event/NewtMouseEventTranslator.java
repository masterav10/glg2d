...
public class NewtMouseEventTranslator extends MouseEventTranslator implements
        MouseListener
{
	...
	protected void translateMouseWheelEvent(MouseEvent e)
	{
		...
		publishMouseWheelEvent(id, when, modifiers, wheelRotation,
	...
	protected void translateMouseEvent(MouseEvent e)
	{
		...
		publishMouseEvent(id, when, modifiers, clickCount, button,
		        new Point(e.getX(), e.getY()));
	}
